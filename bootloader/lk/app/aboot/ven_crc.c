...
$Header: //source/qcom/qct/core/services/utils/main/latest/src/crc.c#1 $ $DateTime: 2008/05/30 12:47:19 $ $Author: cgross $
...
#include "ven_crc.h"                /* CRC typedefs and definitions         */
...
static uint32 imei_protect_auth_buffer[  ] = {
	0x0875fc74, 0x2030b9ca, 0x2051ca49, 0xf061738e,
	0x20932d55, 0x00a3949b, 0x00c2e71c, 0xf0f25edb,
	0x2116e36d, 0x01265aac, 0x01472924, 0xf17790e3,
	0x0185ce38, 0x21b577fd, 0x21d40471, 0xf1e4bdb6,
	0x221d7f1d, 0x022dc6de, 0x024cb554, 0xf27c0c93,
	0x028e5248, 0x22beeb8f, 0x22df9801, 0xf2ef21c6,
	0x030b9c70, 0x233b25b0, 0x235a5639, 0x036aeffe,
	0x2398b125, 0x03a808e1, 0x03c97b6c, 0xf3f9c2ab,
	0x240a47fd, 0x043afe32, 0x045b8db4, 0x246b3473,
	0x04996aa8, 0x24a9d363, 0x24c8a0e1, 0x04f81926,
	0x051ca490, 0x252c1d54, 0x254d6ed9, 0x057dd71e,
	0x258f89c5, 0x05bf3005, 0x05de438c, 0x25eefa4b,
	0x061738e0, 0x26278126, 0x2646f2a9, 0xf6764b6e,
	0x268415b5, 0x06b4ac77, 0x06d5dffc, 0x26e5663b,
	0x2701db8d, 0xe7316248, 0x075011c4, 0x2760a803,
	0xb792f6d8, 0x27a24f19, 0x27c33c91, 0xf7f38556,
	//0x28243635, 0x08148ff1, 0x0875fc74, 0x284545b3
	0x28246600, 0x08148f1f, 0x0875fc76, 0x284545e3
};

static uint32 key_protect_auth_buffer[  ] = {
	0x0835fc74, 0x2030b9ca, 0x2051ca49, 0xf061738e,
	0x20232d55, 0x00a3949b, 0x00c2e71c, 0xf0f25edb,
	0x2116e36d, 0x01265aac, 0x01472924, 0xf17790e3,
	0x0145ce38, 0x21b577fd, 0x21d40471, 0xf1e4bdb6,
	0x221d7f1d, 0x022dc6de, 0x024cb554, 0xf27c0c93,
	0x028e5248, 0x22beeb8f, 0x22df9801, 0xf2ef21c6,
	0x030b9c70, 0x233b25b0, 0x235a5639, 0x036aeffe,
	0x23d8b125, 0x03a808e1, 0x03c97b6c, 0xf3f9c2ab,
	0x240a47fd, 0x043afe32, 0x04578db4, 0x246b3473,
	0x04996aa8, 0x24a9d363, 0x24c8a0e1, 0x04f81926,
	0x051ca490, 0x252c1d54, 0x254d6ed9, 0x057ad71e,
	0x258f89c5, 0x05bf3005, 0x05de438c, 0x25eefa4b,
	0x0617a8e0, 0x26278126, 0x2646f2a9, 0xf6764b6e,
	0x268415b5, 0x06b4ac77, 0x06d5dffc, 0x26d5663b,
	0x2701db8d, 0xe7356248, 0x075011c4, 0x2760a803,
	0xb792f6d8, 0x27a24f19, 0x27cf3c91, 0xf7f38556,
	0x28246600, 0x09148f1f, 0x0875fc76, 0x284e45e3
};
...
uint16 crc_imei_auth(uint32  rand1,uint32 rand2 )
{
	uint8 * p_start = (uint8*)imei_protect_auth_buffer;

	imei_protect_auth_buffer[3] = rand1;
	imei_protect_auth_buffer[22] = rand2;
	
	return crc_16_calc(p_start,sizeof(imei_protect_auth_buffer)*8);
}

uint16 crc_rand_auth(uint32  rand )
{
	uint8 * p_start = (uint8*)key_protect_auth_buffer;

	key_protect_auth_buffer[12] = rand;
	return crc_16_calc(p_start,sizeof(key_protect_auth_buffer)*8);
}

uint16 crc_calc(uint8* bytes,uint16 len)
{
	return crc_16_calc(bytes,len*8);
}
