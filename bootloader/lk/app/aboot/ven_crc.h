...
Copyright (c) 1992-2011 QUALCOMM Incorporated.
All rights reserved.
...
$Header: //source/qcom/qct/core/api/services/utils/main/latest/crc.h#4 $ $DateTime: 2011/04/12 11:27:23 $ $Author: coresvc $
...
#include "ven_def.h"     /* Definitions for byte, word, etc.     */
#include "sys/types.h"
#include <scm.h>
/*===========================================================================
