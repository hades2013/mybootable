...
class complex_general_properties(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, selected_signer=None, selected_encryptor=None, selected_cert_config=None, max_cert_size=None, key_size=None, num_certs_in_certchain=None, num_root_certs=None, testsig_serialnum=None, mrc_index=None, msm_part=None, oem_id=None, model_id=None, sw_id=None, app_id=None, crash_dump=None, rot_en=None, soc_hw_version=None, mask_soc_hw_version=None, debug=None, exponent=None, object_id=None, pmbl_properties=None, cass_capability=None):
    ...
    def hasContent_(self):
        if (
            ...
            self.cass_capability is not None
            ):
            return True
        else:
            return False
