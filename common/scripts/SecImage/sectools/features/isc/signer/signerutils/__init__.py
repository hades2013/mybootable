...
def get_hmac_params_from_config(default_attributes):
    ...
    :rtype: obj
    """
    if default_attributes.msm_part is not None:
        msm_identifier = int(default_attributes.msm_part, 16)
    else:
        msm_identifier = (int(default_attributes.soc_hw_version, 16) & (int(default_attributes.mask_soc_hw_version, 16) | 0xFFFF0000))

    oem_id = (int(default_attributes.oem_id, 16) & 0xFFFF)
    model_id = (int(default_attributes.model_id, 16) & 0xFFFF)
