...
static dsi_id_str_map_t embms_act_status_map[] =
  {
    {QMI_WDS_EMBMS_TMGI_ACTIVATE_SUCCESS                 ,"TMGI_ACTIVATE_SUCCESS" },
    {QMI_WDS_EMBMS_TMGI_ACTIVATE_SUCCESS_DUP_ACTIVATE    ,"TMGI_ACTIVATE_SUCCESS_DUP_ACTIVATE"},
    {QMI_WDS_EMBMS_TMGI_ACTIVATE_SUCCESS_IDLE_RADIO_TUNE ,"TMGI_ACTIVATE_SUCCESS_IDLE_RADIO_TUNE" },
    {QMI_WDS_EMBMS_TMGI_ACTIVATE_SUCCESS_CONN_RADIO_TUNE ,"TMGI_ACTIVATE_SUCCESS_CONN_RADIO_TUNE"},
    /* Begin - deprecated from rev 1.49 onwards */
    {QMI_WDS_EMBMS_TMGI_ACTIVATE_FAIL_RADIO_CONFIG       ,"TMGI_ACTIVATE_FAIL_RADIO_CONFIG"},
    {QMI_WDS_EMBMS_TMGI_ACTIVATE_FAIL_CHANNEL_UNAVAILABLE,"TMGI_ACTIVATE_FAIL_CHANNEL_UNAVAILABLE"},
    {QMI_WDS_EMBMS_TMGI_ACTIVATE_FAIL_EMBMS_NOT_ENABLED  ,"TMGI_ACTIVATE_FAIL_EMBMS_NOT_ENABLED"},
    {QMI_WDS_EMBMS_TMGI_ACTIVATE_FAIL_OUT_OF_COVERAGE    ,"TMGI_ACTIVATE_FAIL_OUT_OF_COVERAGE"},
    /* End - deprecated from rev 1.49 onwards */
    {QMI_WDS_EMBMS_TMGI_ACTIVATE_FAIL_UNKNOWN            ,"TMGI_ACTIVATE_FAIL_UNKNOWN"},
    {QMI_WDS_EMBMS_TMGI_ACTIVATE_FAIL_NOT_ALLOWED        ,"TMGI_ACTIVATE_FAIL_NOT_ALLOWED"},
    {QMI_WDS_EMBMS_TMGI_ACTIVATE_FAIL_MISSING_CTL_INFO   ,"TMGI_ACTIVATE_FAIL_MISSING_CTL_INFO"},
    {QMI_WDS_EMBMS_TMGI_ACTIVATE_FAIL_MISSING_TMGI       ,"TMGI_ACTIVATE_FAIL_MISSING_TMGI"},
    {QMI_WDS_EMBMS_TMGI_ACTIVATE_FAIL_MCAST_OOS          ,"TMGI_ACTIVATE_FAIL_MCAST_OOS"},
    {QMI_WDS_EMBMS_TMGI_ACTIVATE_FAIL_UNICAST_OOS        ,"TMGI_ACTIVATE_FAIL_UNICAST_OOS"},
    {QMI_WDS_EMBMS_TMGI_ACTIVATE_FAIL_CAMP_ON_OTHER_FREQ ,"TMGI_ACTIVATE_FAIL_CAMP_ON_OTHER_FREQ"},
    {QMI_WDS_EMBMS_TMGI_ACTIVATE_FAIL_SAI_MISMATCH       ,"TMGI_ACTIVATE_FAIL_SAI_MISMATCH "},
    {QMI_WDS_EMBMS_TMGI_ACTIVATION_FAIL_MAX_TMGI_ALREADY_ACTIVE ,"TMGI_ACTIVATION_FAIL_MAX_TMGI_ALREADY_ACTIVE"},
    {QMI_WDS_EMBMS_TMGI_ACTIVATE_FAIL_ACTIVATIOIN_IN_PROGRESS ,"TMGI_ACTIVATE_FAIL_ACTIVATIOIN_IN_PROGRESS"},
    {QMI_WDS_EMBMS_TMGI_ACTIVATE_FAIL_DEACTIVATION_IN_PROGRESS,"TMGI_ACTIVATE_FAIL_DEACTIVATION_IN_PROGRESS"},
  };

static dsi_id_str_map_t embms_deact_status_map[]=
  {
    {QMI_WDS_EMBMS_TMGI_DEACTIVATE_SUCCESS                       ,"TMGI_DEACTIVATE_SUCCESS "},
    {QMI_WDS_EMBMS_TMGI_DEACTIVATE_FAIL_NOT_ACTIVATED_CTRL_POINT ,"TMGI_DEACTIVATE_FAIL_NOT_ACTIVATED_CTRL_POINT"},
    {QMI_WDS_EMBMS_TMGI_DEACTIVATE_FAIL_NOT_ACTIVATED            ,"TMGI_DEACTIVATE_FAIL_NOT_ACTIVATED"},
    {QMI_WDS_EMBMS_TMGI_DEACTIVATE_FAIL_DEACTIVATION_IN_PROGRESS ,"TMGI_DEACTIVATE_FAIL_DEACTIVATION_IN_PROGRESS"},
  };
...
extern void dsi_fill_addr_info(int dsi_id, dsi_ip_family_t ipf);
