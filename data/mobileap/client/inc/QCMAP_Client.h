...
typedef struct
{
  qcmap_msgr_backhaul_type_enum_v01 first;    /*First backhaul Pref*/
  qcmap_msgr_backhaul_type_enum_v01 second;   /*Second backhaul Pref*/
  qcmap_msgr_backhaul_type_enum_v01 third;    /*Third backhaul Pref*/
}backhaul_pref_t;
...
/** @ingroup qcmap_enable_sta_mode
  ...
  @param[out] qmi_err_num       Error code returned by the server. Few important
...
===========================================================================*/
/** @ingroup qcmap_wlan_status_ind_reg
...
/** @ingroup qcmap_set_firewall
  ...
  @param[in] enable_firewall          Indicates whether the firewall is enabled.
  @param[in] upnp_pinhole_flag      Indicates what the pinhole is to be set.
  @param[out] qmi_err_num           Error code returned by the server.
...
===========================================================================*/
/** @ingroup qcmap_get_tiny_proxy_status
...
=====================================================================*/
/** @ingroup qcmap_msgr_set_dlna_whitelisting
  ...
  @param[in] dlna_whitelisting_allow       Flag to set the Whitelisting IP State.
  @param[out] qmi_err_num                  Error code returned by the server.
...
=====================================================================*/
/** @ingroup qcmap_msgr_get_dlna_whitelisting
  ...
  @param[out] dlna_whitelisting_allow     Flag to get the Whitelisting IP State.
  @param[out] qmi_err_num                  Error code returned by the server.
...
=====================================================================*/
/** @ingroup qcmap_msgr_add_dlna_whitelist_ip
  ...
  @param[in] dlna_whitelisting_ip        DLNA Whitelisting IP being added.
  @param[out] qmi_err_num               Error code returned by the server.
...
=====================================================================*/
/** @ingroup qcmap_msgr_delete_dlna_whitelist_ip
  ...
  @param[in] dlna_whitelisting_ip        DLNA Whitelisting IP being deleted.
  @param[out] qmi_err_num               Error code returned by the server.
...
/** @ingroup qcmap_msgr_set_active_backhaul_pref
  ...
  @param[in] set_backhaul_req_msg   Backhaul Preference
  @param[out] qmi_err_num               Error code returned by the server.
...
/** @ingroup qcmap_msgr_get_backhaul_pref
  ...
  @param[in] resp                    Struct to get Backhaul Preference
  @param[out] qmi_err_num            Error code returned by the server.
