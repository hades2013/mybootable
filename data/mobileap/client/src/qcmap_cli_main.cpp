    ...
    switch (opt)
    {
      ...
      case 82:
      {
        ...
        else if ( options == 1 )
        {
           ...
           fgets( scan_string, sizeof(scan_string), stdin);
           strlcpy( url, scan_string, strlen(scan_string)-1);
     ...
     case 83:
      ...
      case 94:
      {
        ...
        {
          bzero(&scan_string,sizeof(scan_string));
          printf("Enter backhaul (1. WWAN or 2. USB Cradle or 3. WLAN) which has Prioity %d :", i);
          fgets(scan_string, sizeof(scan_string), stdin);
          tmp_input = atoi(scan_string);
          if (tmp_input >= QCMAP_MSGR_WWAN_BACKHAUL_V01 &&
              tmp_input <= QCMAP_MSGR_WLAN_BACKHAUL_V01)
          {
            if (i == 1)
            {
          ...
          {
            printf("Wrong value Entered!!, Please enter ( wwan or cradle or wlan) \n");
          }
        }
