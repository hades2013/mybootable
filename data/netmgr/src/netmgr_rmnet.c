...
)
{
  ...
  if (data_format->ul_data_aggregation_protocol == NETMGR_WDA_UL_QMAPV3)
  {
    egress_flags = RMNET_EGRESS_FORMAT_MAP  | RMNET_EGRESS_FORMAT_MUXING | RMNET_EGRESS_FORMAT_MAP_CKSUMV3;
  }
  else
  {
